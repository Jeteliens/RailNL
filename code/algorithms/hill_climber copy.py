    ...
    def run(self, number_of_runs):
        ...
        for i in range(number_of_runs):
            ...
            for trajectory in self.map.trains:
                ...
                # print(f"Before adding new train: {self.map.all_ridden_connections}")
                # print(f"New train connections: {self.determine_ridden_connections(new_train)}")
                self.map.all_ridden_connections += self.determine_ridden_connections(new_train)
                # print(f"After adding new train: {self.map.all_ridden_connections}")
                ...
                # print(f"After removing old train: {self.map.all_ridden_connections}")
                ...
                # print(f"Before removing duplicates: {self.map.all_ridden_connections}")
                self.map.ridden_connections = self.remove_duplicates(self.map.all_ridden_connections)
                # print(f"After removing duplicates: {self.map.ridden_connections}")
                # if i == 0:
